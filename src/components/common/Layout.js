                       ...
                       <div className="site-mast">
                            ...
                            { isHome ?
                                <div className="site-banner">
                                    <h1 className="site-banner-title">AEM <span class="site-banner-title-highlight">S</span>hack</h1>
